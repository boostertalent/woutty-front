...
import { Loader2, AlertCircle, Mail, Globe, Eye, EyeOff } from 'lucide-react'; // Importation des icônes nécessaires
    ...
    <div className="min-h-screen bg-[#FDFDFD] flex items-center justify-center px-4 py-12 font-sans text-black">
      ...
      >
        <div className="text-center mb-10">
          <Link href="/" className="inline-block bg-black text-white px-4 py-2 rounded-xl font-black text-xl mb-4 transition-transform hover:scale-110">W</Link>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center ml-1">
              ...
              <Link href="/brands/auth/forgot-password" underline className="text-[10px] font-bold uppercase text-gray-400 hover:text-black">Oublié ?</Link>
            </div>
            
            {/* Conteneur relatif pour l'icône */}
            <div className="relative">
              <input
        ...
        <p className="text-center mt-8 text-sm font-medium text-gray-500">
          Pas encore de compte ? <Link href="/brands/auth/register" className="text-black font-black hover:underline">S'inscrire</Link>
        </p>
      </motion.div>
    </div>
  );
