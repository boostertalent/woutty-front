...
import {
  ...
  Shield, AlertCircle, CheckCircle2, Clock, FileVideo
} from 'lucide-react';
...
export default function ValidateSubmissionsPage() {
  ...
  const openVideo = async (submissionId: string) => {
  ...
  const decide = async (submissionId: string, decision: 'approved' | 'rejected', note?: string) => {
    ...
    try {
      const res = await fetch(`/api/submissions/${submissionId}/decide`, {
        ...
        body: JSON.stringify({ decision, adminNote: note ?? null }),
      });
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h1 className="text-3xl font-serif font-bold text-[#111827] mb-2 flex items-center gap-3">
                ...
                Zone Tampon — Vidéos à valider
              </h1>
              <p className="text-gray-400 text-sm">
                Visionnez et validez les vidéos soumises par les créateurs avant publication
              </p>
            </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
            ...
            <p className="text-gray-400">Les vidéos soumises par les créateurs apparaîtront ici</p>
          </div>
        ) : (
                ...
                <div className="p-6">
                  ...
                  {sub.admin_note && (
                    <p className="text-sm text-gray-500 mt-1">
                      Note admin : <span className="italic">{sub.admin_note}</span>
                    </p>
                  )}
                  ...
                  {sub.status === 'pending' && sub.video_path && (
                    <div className="flex flex-wrap gap-3 mt-4">
                      ...
                      <button
                        onClick={() => { setRejectTarget(sub.id); setAdminNote(''); }}
                        disabled={processingId === sub.id}
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <h3 className="font-bold text-gray-900">Visionner la vidéo</h3>
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              placeholder="Ex : La vidéo ne correspond pas au brief de la campagne..."
              rows={4}
            ...
            <div className="flex gap-3 mt-4">
              ...
              <button
                onClick={() => decide(rejectTarget, 'rejected', adminNote || undefined)}
